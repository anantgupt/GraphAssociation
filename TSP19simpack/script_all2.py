...
def main():
    ...
    # Nsens vS Rob
    # set_it(0, rob_rng, [1,3,4],[snr_std, Nob_std, swidth_std])
    # run_it(datef, Nsens_rng,'rob','Nsens')

    # Nsens vS SNR
    # set_it(1, snr_rng, [0,3,4],[rob_std, Nob_std, swidth_std])
    # run_it(datef, Nsens_rng,'snr','Nsens')
    # Nsens vS Nob
    set_it(3, Nob_rng, [0,1,4],[rob_std, snr_std, swidth_std])
    run_it(datef, Nsens_rng,'Nob','Nsens')
    # Nsens vS swidth
