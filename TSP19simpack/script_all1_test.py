...
def main():
    ...
    parser.add_argument('--N_sens', default=4, type=int, help='Num sensors')
    ...
    # Nob vs SNR
    Nob_rng2 = [1]
    snr_rng2 = np.linspace(-26,-12,8)
    set_it(1, snr_rng2, [0,2,4,5],[rob_std, Nsens_std, swidth_std, pmiss_std])
