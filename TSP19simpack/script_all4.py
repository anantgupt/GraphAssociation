...
def main():
    ...
    swidth_rng = [0.1,0.4,0.8,1.6,2.4,4,5]
    ...
    # swidth vS SNR
    # set_it(1, snr_rng, [0,2,3],[rob_std, Nsens_std, Nob_std])
    # run_it(datef, swidth_rng,'snr','swidth')
    # swidth vS Nsens
    # set_it(2, Nsens_rng, [0,1,3],[rob_std, snr_std, Nob_std])
    # run_it(datef, swidth_rng,'Nsens','swidth')
    # swidth vS Nob
    set_it(3, Nob_rng, [0,1,2],[rob_std, snr_std, Nsens_std])
    run_it(datef, swidth_rng,'Nob','swidth')
